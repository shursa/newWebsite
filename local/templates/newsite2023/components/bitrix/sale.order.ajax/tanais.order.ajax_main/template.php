...
else
{
			...
			<div class="tanais-main-block bx-soa">
				...
				<div id="bx-soa-orderSave">
					<div class="checkbox">
						...
						{
							$APPLICATION->IncludeComponent("bitrix:main.userconsent.request", "main.userconsent.request_main", Array(
	"ID" => $arParams["USER_CONSENT_ID"],	// Соглашение
		...
		"AUTO_SAVE" => "N",	// Сохранять автоматически факт согласия
	...
	<div style="display: none">
		...
		$APPLICATION->IncludeComponent("bitrix:sale.location.selector.steps", "sale.location.selector.steps_main", Array(
	
	),
	false
);
		$APPLICATION->IncludeComponent("bitrix:sale.location.selector.search", "location.selector.search_main", Array(
